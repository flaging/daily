...
### [MetaAI提出DIFFMAE：扩散模型与MAE的首次结合](https://hub.baai.ac.cn/view/25331)
* DIFFUSION+MAE: [arxiv](https://arxiv.org/pdf/2304.03283.pdf)

### [FastChat](https://github.com/lm-sys/FastChat)
* 小羊驼, 低成本finetune LLAMA的模型, 公开的权重delta在[这里](https://huggingface.co/lmsys/vicuna-7b-delta-v0)
...
### [What Every Programmer Should Know About Memory](https://akkadia.org/drepper/cpumemory.pdf?continueFlag=15536bed1e034a7d436f2d0584e6fa6b)
* 内存知识
...
* python包构建规则, 还有一个[实例](https://github.com/pypa/pip-audit/blob/main/pyproject.toml)

### [KARMEM](https://github.com/inkeliz/karmem)
* 序列化库, 比flatten buffer快10倍

### [CPU Specs Database](https://www.techpowerup.com/cpu-specs/)
* 消费级CPU spec信息, 另外还有[GPU](https://www.techpowerup.com/gpu-specs/), [SSD](https://www.techpowerup.com/ssd-specs/)等
...
### [打造程序员完美的终端环境，颜值爆表，效率 X 10倍](https://vikingz.me/best-terminal-setup/?continueFlag=15536bed1e034a7d436f2d0584e6fa6b)
* 学习配置iterm2环境

### [Excellent Free Resource For Programmers: Code Simplicity](https://www.codesimplicity.com/wp-content/uploads/2022/05/CodeSimplicity.pdf?continueFlag=15536bed1e034a7d436f2d0584e6fa6b)
* 程序员资料

### [Does a compiler use all x86 instructions?](http://pepijndevos.nl/2016/08/24/x86-instruction-distribution.html?continueFlag=15536bed1e034a7d436f2d0584e6fa6b)
* 查看编译器命令情况

### [all-you-need-is-arxiv-search](https://github.com/goodnlp/all-you-need-is-arxiv-search)
* arxiv搜索工具, 网站在[这里](https://www.arxiv.dev/)
